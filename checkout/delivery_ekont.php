...
if (!$eorow) {
    ...
    $editID = (int)$eorow[$bean->getPrKey()];
...
echo "<div class='item ekont_locator'>";      
    ...
    echo "</div>";
    ?>
    <iframe id="ekont_frame" scrolling="no" frameborder="0" style="border: medium none; width: 800px; height: 450px;" allowtransparency="true" src="http://www.bgmaps.com/templates/econt?office_type=all&shop_url=<?php echo SITE_URL;?>"></iframe>
    <?php
